...
public class Size88Fragment extends Fragment {

    private final int pixelNum = 8; //픽셀의 개수
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_size88, container, false);

        canvusLayout = (TableLayout) v.findViewById(R.id.size88_canvus_layout);
        ...
        for(i=0; i < pixelNum; i += 1) {
            ...
            for (j = 0; j < pixelNum; j += 1) {
                ...
                int finalI = i;
                int finalJ = j;
                pixels[i][j].setOnClickListener(new PixelClickListener(finalI, finalJ) {
                    @Override
